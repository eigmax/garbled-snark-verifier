...
impl Fq6 {
    ...
    pub fn as_montgomery(a: ark_bn254::Fq6) -> ark_bn254::Fq6 {
        ark_bn254::Fq6::new(Fq2::as_montgomery(a.c0), Fq2::as_montgomery(a.c1), Fq2::as_montgomery(a.c2))
    }
...
mod tests {
    ...
    fn test_fq6_mul_montgomery() {
        let a = random_fq6();
        let b = random_fq6();
        let circuit = Fq6::mul_montgomery(wires_set_from_fq6(Fq6::as_montgomery(a.clone())), wires_set_from_fq6(Fq6::as_montgomery(b.clone())));
        circuit.print_gate_type_counts();
        for mut gate in circuit.1 {
            gate.evaluate();
        }
